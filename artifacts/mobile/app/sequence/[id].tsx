...
const styles = StyleSheet.create({
  ...
  saveText: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: Colors.info },
  deleteBtn: { flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "flex-end", marginBottom: 16 },
  deleteText: { fontSize: 14, fontFamily: "Inter_500Medium", color: Colors.error },
  formGroup: { marginBottom: 20 },
  label: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.textSecondary, marginBottom: 6, textTransform: "uppercase" },
  input: { backgroundColor: Colors.surface, borderRadius: 12, padding: 14, fontSize: 16, fontFamily: "Inter_400Regular", color: Colors.text },
  ...
  stepNumText: { fontSize: 13, fontFamily: "Inter_700Bold", color: Colors.info },
  stepInfo: { flex: 1 },
  stepName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: Colors.text },
  stepDelay: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.textSecondary, marginTop: 2 },
  addStepSection: { backgroundColor: Colors.surfaceSecondary, borderRadius: 14, padding: 16, marginTop: 8 },
  addStepTitle: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: Colors.text, marginBottom: 12 },
  ...
  templateOptionText: { fontSize: 14, fontFamily: "Inter_500Medium", color: Colors.text },
  ...
  enrollText: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary },
});
