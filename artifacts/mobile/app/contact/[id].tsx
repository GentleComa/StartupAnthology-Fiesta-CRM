...
const styles = StyleSheet.create({
  ...
  relText: { fontSize: 12, fontFamily: "Inter_600SemiBold", textTransform: "capitalize" },
  ...
  actionText: { fontSize: 12, fontFamily: "Inter_500Medium", color: Colors.text },
  infoSection: { backgroundColor: Colors.surface, borderRadius: 14, padding: 14, marginBottom: 20, gap: 10 },
  infoRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  infoText: { fontSize: 14, fontFamily: "Inter_400Regular", color: Colors.textSecondary, flex: 1 },
  ...
  quickText: { fontSize: 14, fontFamily: "Inter_500Medium", color: Colors.text },
