...
const styles = StyleSheet.create({
  ...
  betaCountText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.primary },
  ...
  columnTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: Colors.text, flex: 1 },
  columnCount: { fontSize: 13, fontFamily: "Inter_500Medium", color: Colors.textSecondary, backgroundColor: Colors.surface, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  ...
  leadName: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: Colors.text, flex: 1 },
  leadEmail: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary, marginTop: 2 },
  ...
  betaBadgeText: { fontSize: 10, fontFamily: "Inter_700Bold", color: Colors.accent },
  sourceText: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.textTertiary },
  ...
  emptySubtitle: { fontSize: 14, fontFamily: "Inter_400Regular", color: Colors.textTertiary },
  fab: {
    position: "absolute",
    bottom: 100,
    right: 20,
  ...
  cancelBtn: { fontSize: 16, fontFamily: "Inter_400Regular", color: Colors.info },
  saveBtn: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: Colors.info },
  saveBtnDisabled: { opacity: 0.4 },
  formGroup: { marginBottom: 20 },
  formLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.textSecondary, marginBottom: 6, textTransform: "uppercase" },
  input: {
  ...
  sourceChipText: { fontSize: 13, fontFamily: "Inter_500Medium", color: Colors.text, textTransform: "capitalize" },
