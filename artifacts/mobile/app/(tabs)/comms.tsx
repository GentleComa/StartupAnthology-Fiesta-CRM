...
const styles = StyleSheet.create({
  ...
  cardSubtitle: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary, marginTop: 2 },
  cardDate: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.textTertiary, marginTop: 2 },
  ...
  audienceText: { fontSize: 11, fontFamily: "Inter_500Medium", color: Colors.textSecondary, textTransform: "capitalize" },
