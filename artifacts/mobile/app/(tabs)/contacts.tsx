...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 18, fontFamily: "Inter_600SemiBold", color: "#fff" },
  contactInfo: { flex: 1 },
  contactName: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: Colors.text },
  contactCompany: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary, marginTop: 1 },
  ...
  relText: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "capitalize" },
