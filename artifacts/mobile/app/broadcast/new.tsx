...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 16, fontFamily: "Inter_400Regular", color: Colors.info },
  ...
  stepTitle: { fontSize: 20, fontFamily: "Inter_700Bold", color: Colors.text, marginBottom: 16 },
  segLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: Colors.textSecondary, marginBottom: 8, marginTop: 12, textTransform: "uppercase" },
  ...
  chipText: { fontSize: 13, fontFamily: "Inter_500Medium", color: Colors.text, textTransform: "capitalize" },
  ...
  templateName: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: Colors.text },
  templateSubject: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary, marginTop: 2 },
  noTemplates: { fontSize: 14, fontFamily: "Inter_400Regular", color: Colors.textTertiary, textAlign: "center", paddingVertical: 20 },
  previewInfo: { backgroundColor: Colors.surfaceSecondary, borderRadius: 12, padding: 14, marginBottom: 12, gap: 4 },
  previewLabel: { fontSize: 13, fontFamily: "Inter_500Medium", color: Colors.textSecondary, textTransform: "capitalize" },
  recipientCount: { fontSize: 16, fontFamily: "Inter_700Bold", color: Colors.text, marginBottom: 12 },
  ...
  recipientName: { flex: 1, fontSize: 14, fontFamily: "Inter_500Medium", color: Colors.text },
  recipientEmail: { fontSize: 13, fontFamily: "Inter_400Regular", color: Colors.textSecondary },
  ...
  summaryValue: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: Colors.text, textTransform: "capitalize" },
